...
const FeatureStrip = () => {
  return (
    <div className="bg-[#14212A] text-[#02A6DC] flex flex-col md:flex-row justify-around py-8 md:py-4">
...
const FeatureEle: React.FC<FeatureEleProps> = ({ logo, figure, label }) => {
  return (
    <div className="flex flex-col items-center md:flex-row gap-4 md:gap-8 p-4">
      <img src={logo} alt={label} className="w-16 h-16 md:w-20 md:h-20" />
