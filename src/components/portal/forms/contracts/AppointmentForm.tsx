...
const AppointmentForm: React.FC = () => {
  return (
    <div className=" min-h-screen bg-white mx-auto ">
      ...
      <div className="">
        <h1 className="text-[#3285ca] text-[28px] mb-2">Appointment of Agent for Property Tax Matters</h1>
        <p className="text-xs mb-2">This form is for use by a property owner in designating a lessee or other person to act as the owner's agent in property tax matters. You should read all
          ...
          district by the owner or the owner's designated agent, or (2) the expiration date, if any, designated below</p>
        <p className="text-xs font-bold">
          In some cases, you may want to contact your appraisal district or other local taxing units for free information and/or forms concerning your
      ...
      <div>
        <div className="flex justify-between ">
          ...
          <div className="flex-[1] mx-2">
            ...
            <p className="text-xs">Date Received (appraisal district use only)</p>
          </div>
        </div>
        {/* Step: 1 */}
        <div>
          ...
          <div >
            <div className="flex justify-between  ">
              <div className="flex-[2] mx-2">
                <p className="border-b text-sm border-[#3285ca]">NADAR VIGNESHWAR NAIK SMITA</p>
            ...
            <div className="m-2">
              <p className="text-sm border-b border-[#3285ca]">23518 ATWOOD LANDING LN</p>
              <p className="text-xs">Address</p>
            </div>
            <div className="m-2">
              <p className="text-sm border-b border-[#3285ca]"> KATY, TX 77493-3384</p>
        ...
        <div>
          <div className="m-2 mt-8 px-1 text-white bg-[#3285ca]">
            <p className="text-sm">
              STEP 2: Identify the Property for Which Authority is Granted. Identify all property for which you are granting the agent authority
              and, unless granting authority for all property listed for you, provide at least one of the property identifiers listed below (appraisal
          ...
          <div>
            <div className="m-2 text-xs">
              ...
              <div className="flex items-center my-1 ">
                <input type="checkbox" />
                <p className="mx-2">all property listed for me at the above address</p>
              </div>
            ...
            <div >
              <div className="flex justify-between  ">
                <div className="flex-[1] mx-2">
                  <p className="border-b text-sm border-[#3285ca]">1385790010006</p>
                  <p className="text-xs">Appraisal District Account Number</p>
                </div>
                <div className="flex-[2] mx-2">
                  <p className="text-sm border-b border-[#3285ca] ">23518 ATWOOD LANDING LN KATY, TX 77493-3384</p>
                  <p className="text-xs">Physical or Situs Address of Property</p>
                </div>
              </div>
              <div className="m-2">
        ...
        <div>
          ...
          <div className="flex justify-between  ">
            <div className="flex-[2] mx-2">
              <p className="border-b text-sm border-[#3285ca]">Lone Star Property Tax, LLC</p>
              <p className="text-xs">Name</p>
            </div>
            <div className="flex-[1] mx-2">
          ...
          <div className="m-2">
            <p className="text-sm border-b border-[#3285ca]">1327 Kyle Hill Lane</p>
            <p className="text-xs">Address</p>
          </div>
          <div className="m-2">
            <p className="text-sm border-b border-[#3285ca]">Sugar Land, TX 77479</p>
            <p className="text-xs">City, State, Zip Code</p>
          </div>
        </div>
        {/* Step: 4 */}
        <div>
          ...
          <div className="m-2 text-xs">
            <p>The agent identified above is authorized to represent me in (check one):</p>
            <div className="flex items-center my-1 ">
              <input type="checkbox" />
              <p className="mx-2">all property tax matters concerning the property identified</p>
            </div>
            <div className="flex items-center">
              <input type="checkbox" />
              <p className="mx-2"> the following specific property tax matters:</p>
            </div>
          </div>
          <p className="ml-8 my-4 border-b mr-2 border-[#3285ca]"></p>
          <div className="flex">
            <p className="text-xs m-2">The agent identified above is authorized to receive confidential information pursuant to Tax Code Sections 11.48(b)(2),
              22.27(b)(2), 23.123(c)(2), 23.126(c)(2) and 23.45(b)(2):</p>
          ...
          <div className="m-2 text-xs">
            <div className="flex items-center my-1 ">
              <input type="checkbox" />
              <p className="mx-2"> all communications from the chief appraiser</p>
            </div>
            <div className="flex items-center my-1 ">
              <input type="checkbox" />
              <p className="mx-2"> all communications from the appraisal review board</p>
            </div>
            <div className="flex items-center my-1 ">
              <input type="checkbox" />
              <p className="mx-2"> all communications from all taxing units participating in the appraisal district</p>
            </div>
          </div>
        </div>
        {/* Step: 5 */}
        <div>
          ...
          <div className="flex items-center m-2 my-4">
            <p className="flex-[1] text-xs">Date Agent's Authority Ends . . . </p>
        ...
        <div className="m-2 mt-8 page-break">
          ...
          <div className="flex items-center mt-4">
            <div className="flex font-bold text-lg flex-[1]">sign <br /> Here <p> &#129034;</p></div>
            <div className="mt-4 mr-4">
              <p className="flex-[8] text-xs border-b border-[#3285ca]">.</p>
              <p className="text-xs">Signature of Property Owner, Property Manager or Other Person</p>
              <p className="text-xs">Authorized to Act on Behalf of the Property Owner*</p>
            </div>
          ...
          <div className="flex items-center mt-4">
            <div className="flex font-bold text-lg flex-[1]">print <br /> Here <p> &#129034;</p></div>
            <div className="mt-4 mr-4">
              <p className="flex-[8] text-xs border-b border-[#3285ca]">.</p>
              <p className="text-xs">Printed Name of Property Owner, Property Manager or Other Person</p>
              <p className="text-xs">Authorized to Act on Behalf of the Property Owner</p>
            </div>
            <div className="flex-[2]">
              <p className=" text-xs border-b border-[#3285ca]">.</p>
          ...
          <div className="my-4">
            <div className="m-2 text-xs">
              <p className="font-bold">The individual signing this form is (check one):</p>
              <div className="flex items-center my-1 ">
                <input type="checkbox" />
              ...
              <div className="flex items-center my-1 ">
                <input type="checkbox" />
                <p className="mx-2"> a property manager authorized to designate agents for the owner</p>
              </div>
              <div className="flex items-center">
                <input type="checkbox" />
                <p className="mx-2"> other person authorized to act on behalf of the owner other than the person being designated as agent</p>
              </div>
            </div>
          </div>
          <p className="text-xs">* This form must be signed by the property owner, a property manager authorized to designate agents for the owner or other person authorized to act on behalf of the owner
            ...
            you to designate agents or act on behalf of the property owner.</p>
          <p className="font-bold text-xs mt-2">If you make a false statement on this form, you could be found guilty of a Class A misdemeanor or a state jail felony under Penal Code Section 37.10.</p>
        </div>
      </div>
